...
describe('resource v1', () => {
  ...
  test.skip('getBookings: only required params', async () => {
    const responsePromise = client.api.v1.getBookings({ siteId: 'siteId' });
  ...
  // skipped: tests are disabled for the time being
  test.skip('getBookings: required and optional params', async () => {
    const response = await client.api.v1.getBookings({
      siteId: 'siteId',
      cursor: 'cursor',
      pageSize: 'pageSize',
      status: 'CANCELLED',
