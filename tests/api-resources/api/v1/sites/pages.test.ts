...
describe('resource pages', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.api.v1.sites.pages.create('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
      name: 'name',
      pageTheme: { componentPageThemeId: 'componentPageThemeId' },
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.api.v1.sites.pages.create('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
      name: 'name',
  ...
  test.skip('list', async () => {
    const responsePromise = client.api.v1.sites.pages.list('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
