...
import create_sites_invitations from './sites/invitations/create-sites-invitations';
import retrieve_sites_invitations from './sites/invitations/retrieve-sites-invitations';
import list_sites_invitations from './sites/invitations/list-sites-invitations';
import delete_sites_invitations from './sites/invitations/delete-sites-invitations';
import create_sites_memberships from './sites/memberships/create-sites-memberships';
import retrieve_sites_memberships from './sites/memberships/retrieve-sites-memberships';
import update_sites_memberships from './sites/memberships/update-sites-memberships';
import list_sites_memberships from './sites/memberships/list-sites-memberships';
import delete_sites_memberships from './sites/memberships/delete-sites-memberships';
...
import retrieve_workspaces_memberships from './workspaces/memberships/retrieve-workspaces-memberships';
import update_workspaces_memberships from './workspaces/memberships/update-workspaces-memberships';
import delete_workspaces_memberships from './workspaces/memberships/delete-workspaces-memberships';
import retrieve_invitations from './invitations/retrieve-invitations';
import delete_invitations from './invitations/delete-invitations';
...
addEndpoint(create_sites_invitations);
addEndpoint(retrieve_sites_invitations);
addEndpoint(list_sites_invitations);
addEndpoint(delete_sites_invitations);
addEndpoint(create_sites_memberships);
addEndpoint(retrieve_sites_memberships);
addEndpoint(update_sites_memberships);
addEndpoint(list_sites_memberships);
addEndpoint(delete_sites_memberships);
...
addEndpoint(retrieve_workspaces_memberships);
addEndpoint(update_workspaces_memberships);
addEndpoint(delete_workspaces_memberships);
addEndpoint(retrieve_invitations);
addEndpoint(delete_invitations);
