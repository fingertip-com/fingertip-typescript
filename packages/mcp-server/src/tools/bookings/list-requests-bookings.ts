...
export const handler = async (client: Fingertip, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.bookings.listRequests(body).asResponse();
