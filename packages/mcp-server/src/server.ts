...
import { ClientOptions } from 'fingertip';
...
export { ClientOptions } from 'fingertip';
...
export function initMcpServer(params: {
  ...
  const client = new Fingertip(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new Fingertip({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
